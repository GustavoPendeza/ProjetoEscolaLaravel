...
<h1>Atualização de categoria de estudo</h1>
...
<form action="{{route('admin.category.edit', ['category' => $category->id])}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="form-floating">
            ...
            <input type="text" name="name" class="form-control" id="floatingCategoria" placeholder="Categoria" value="{{$category->name}}" required>
